...
//        }
    ...
    private void readNames() {
        ...
        for (int r = 1; r <= rows; r++) {
            ...
            cell_is_full(m_teacher_second_name, row.getCell(0));
            cell_is_full(f_teacher_second_name, row.getCell(1));
            cell_is_full(f_firstname, row.getCell(2));
            cell_is_full(m_firstname, row.getCell(3));
            cell_is_full(m_middle_name, row.getCell(4));
            cell_is_full(f_middle_name, row.getCell(5));
            cell_is_full(m_s_last_name, row.getCell(6));
            cell_is_full(f_s_last_name, row.getCell(7));
        }
